 ...
 */
public class StreamingSimulatorOneEach extends StreamingSimulator<SingleFSDetection> {

	public StreamingSimulatorOneEach(ParameterSpace parameterSpace,
	...
	public static void main(String[] args) {
		System.out.println("New Version of Streaming Algorithm");
		...
		try {
			...
			StreamingSimulatorOneEach globalFS = new StreamingSimulatorOneEach(parameterSpace, new RuntimeStatistics());
