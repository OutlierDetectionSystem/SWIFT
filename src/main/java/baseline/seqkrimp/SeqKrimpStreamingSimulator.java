 ...
 */
public class SeqKrimpStreamingSimulator extends StreamingSimulator<SingleFSDetection> {

	public SeqKrimpStreamingSimulator(ParameterSpace parameterSpace,
									  RuntimeStatisticsSeqKrimp runtimeStatisticsSeqKrimp) {
		super(parameterSpace, runtimeStatisticsSeqKrimp);
	}
	...
	public static void main(String[] args) {
		System.out.println("New Version of SeqKrimp Algorithm");
		...
		try {
			...
			RuntimeStatisticsSeqKrimp runtimeStatisticsSeqKrimp = new RuntimeStatisticsSeqKrimp();
			SeqKrimpStreamingSimulator globalFS = new SeqKrimpStreamingSimulator(parameterSpace, runtimeStatisticsSeqKrimp);
